...
class DragSpeed {
    constructor(gameObject, config) {
        ...
        this.scene = gameObject.scene || undefined;
        // Event emitter
    ...
    get speed() {
        if ((this.x === this.pTooqing) && (this.y === this.preY)) {
            return 0;
        }
        var d = DistanceBetween(this.pTooqing, this.preY, this.x, this.y);
