...
class Table {
    ...
    rowIndexToHeight(start, end) {
        // defaultCellHeightMode
        if (this.defaultCellHeightMode) {
            return ((end - start + 1) * this.defaultCellHeight + this.defaultCellHeight * this.cellOriginY) * this.zoom;
        }
    ...
    colIndexToWidth(start, end) {
        return ((end - start + 1) * this.defaultCellWidth + this.defaultCellWidth * this.cellOriginX) * this.zoom;
    };
