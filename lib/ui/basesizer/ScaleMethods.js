...
export default {
    /**
     * @function TooqinUI.BaseSizer.popUp
    ...
    /**
     * @function TooqinUI.BaseSizer.popUpPromise
     * @param {number} duration 
     * @param {number} orientation 
     * @param {*} ease 
     * @return {Promise<*>}
    ...
    /**
     * @function TooqinUI.BaseSizer.scaleDownDestroy
     * @param {number} duration 
     * @param {number} orientation 
     * @param {*} ease 
     * @param {*} destroyMode 
    ...
    /**
     * @function TooqinUI.BaseSizer.scaleDownDestroyPromise
     * @param {number} duration 
     * @param {number} orientation 
     * @param {*} ease 
     * @param {*} destroyMode 
    ...
    /**
     * @function TooqinUI.BaseSizer.scaleDown
     * @param {number} duration 
     * @param {number} orientation 
     * @param {*} ease 
     */
    ...
    /**
     * @function TooqinUI.BaseSizer.scaleDownPromise
     * @param {number} duration 
     * @param {number} orientation 
     * @param {*} ease 
     * @return {Promise<*>}
