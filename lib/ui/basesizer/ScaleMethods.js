...
export default {
    /**
     * @function tooqingui.basesizer.popUp
    ...
    /**
     * @function tooqingui.basesizer.popUpPromise
     * @param {number} duration 
     * @param {number} orientation 
     * @param {*} ease 
     * @return {Promise<*>}
    ...
    /**
     * @function tooqingui.basesizer.scaleDownDestroy
     * @param {number} duration 
     * @param {number} orientation 
     * @param {*} ease 
     * @param {*} destroyMode 
    ...
    /**
     * @function tooqingui.basesizer.scaleDownDestroyPromise
     * @param {number} duration 
     * @param {number} orientation 
     * @param {*} ease 
     * @param {*} destroyMode 
    ...
    /**
     * @function tooqingui.basesizer.scaleDown
     * @param {number} duration 
     * @param {number} orientation 
     * @param {*} ease 
     */
    ...
    /**
     * @function tooqingui.basesizer.scaleDownPromise
     * @param {number} duration 
     * @param {number} orientation 
     * @param {*} ease 
     * @return {Promise<*>}
