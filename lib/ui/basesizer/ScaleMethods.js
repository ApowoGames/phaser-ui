...
export default {
    ...
    /**
     * @function phaserui.popUpPromise
     * @param {number} duration 
     * @param {number} orientation 
     * @param {*} ease 
     * @return {Promise<*>}
    ...
    /**
     * @function phaserui.scaleDownDestroy
     * @param {number} duration 
     * @param {number} orientation 
     * @param {*} ease 
     * @param {*} destroyMode 
    ...
    /**
     * @function phaserui.scaleDownDestroyPromise
     * @param {number} duration 
     * @param {number} orientation 
     * @param {*} ease 
     * @param {*} destroyMode 
    ...
    /**
     * @function phaserui.scaleDownPromise
     * @param {number} duration 
     * @param {number} orientation 
     * @param {*} ease 
     * @return {Promise<*>}
