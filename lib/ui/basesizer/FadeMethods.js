...
export default {
    /**
     * @function TooqinUI.BaseSizer.FadeMethods
    ...
    /**
     * @function TooqinUI.BaseSizer.fadeInPromoise
     * @param {number} duration 
     * @param {number} alpha 
     * @return {Promise}
     */
    ...
    /**
     * @function TooqinUI.BaseSizer.fadeOutDestroy
     * @param {number} duration 
     * @param {*} destroyMode 
     */
    ...
    /**
     * @function TooqinUI.BaseSizer.fadeOutDestroyPromise
     * @param {number} duration 
     * @param {*} destroyMode 
     * @return {Promise}
     */
    ...
    /**
     * @function TooqinUI.BaseSizer.fadeOut
     * @param {number} duration 
     */
    fadeOut(duration) {
    ...
    /**
     * @function TooqinUI.BaseSizer.fadeOutPromise
     * @param {number} duration 
     * @return {Promise}
     */
