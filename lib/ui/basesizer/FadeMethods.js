...
export default {
    ...
    /**
     * @function phaserui.fadeInPromoise
     * @param {number} duration 
     * @param {number} alpha 
     * @return {Promise<*>}
     */
    ...
    /**
     * @function phaserui.fadeOutDestroy
     * @param {number} duration 
     * @param {*} destroyMode 
     */
    ...
    /**
     * @function phaserui.fadeOutDestroyPromise
     * @param {number} duration 
     * @param {*} destroyMode 
     * @return {Promise<*>}
     */
    ...
    /**
     * @function phaserui.fadeOutPromise
     * @param {number} duration 
     * @return {Promise<*>}
     */
