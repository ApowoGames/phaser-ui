...
export default {
    /**
     * @function apowophaserui.FadeMethods
    ...
    /**
     * @function apowophaserui.fadeInPromoise
     * @param {number} duration 
     * @param {number} alpha 
     * @return {Promise<*>}
     */
    ...
    /**
     * @function apowophaserui.fadeOutDestroy
     * @param {number} duration 
     * @param {*} destroyMode 
     */
    ...
    /**
     * @function apowophaserui.fadeOutDestroyPromise
     * @param {number} duration 
     * @param {*} destroyMode 
     * @return {Promise<*>}
     */
    ...
    /**
     * @function apowophaserui.fadeOut
     * @param {number} duration 
     */
    fadeOut(duration) {
    ...
    /**
     * @function apowophaserui.fadeOutPromise
     * @param {number} duration 
     * @return {Promise<*>}
     */
