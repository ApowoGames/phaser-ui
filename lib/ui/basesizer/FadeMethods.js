...
export default {
    /**
     * @function tooqingui.basesizer.FadeMethods
    ...
    /**
     * @function tooqingui.basesizer.fadeInPromoise
     * @param {number} duration 
     * @param {number} alpha 
     * @return {Promise<*>}
     */
    ...
    /**
     * @function tooqingui.basesizer.fadeOutDestroy
     * @param {number} duration 
     * @param {*} destroyMode 
     */
    ...
    /**
     * @function tooqingui.basesizer.fadeOutDestroyPromise
     * @param {number} duration 
     * @param {*} destroyMode 
     * @return {Promise<*>}
     */
    ...
    /**
     * @function tooqingui.basesizer.fadeOut
     * @param {number} duration 
     */
    fadeOut(duration) {
    ...
    /**
     * @function tooqingui.basesizer.fadeOutPromise
     * @param {number} duration 
     * @return {Promise<*>}
     */
