import TextStyle from '../../plugins/gameobjects/text/textbase/textstyle/TextStyle';
...
var parser = {
    /**
     * @method Tooqingui.parser#splitText
     * @param {string} text 
     * @param {*} mode 
     * @return {any[]}
     */
    ...
    /**
     * @method Tooqingui.parser#tagTextToProp
     * @param {string} text 
     * @param {*} prevProp 
     * @return {*}
     */
...
module.exports = Tooqingui.parser;