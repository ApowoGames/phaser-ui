...
class Text extends GameObject {
    constructor(scene, x, y, text, style, type, parser) {
        ...
        /**
         * @name phaserui.Text#displayWidth
         * @type {number}
         */
        this.displayWidth;
        /**
         * @name phaserui.Text#displayHeight
         * @type {number}
         */
        this.displayHeight;
        ...
        /**
         * @name phaserui.Text#width
         * @type {number}
         */
        this.width = 1;
        /**
         * @name phaserui.Text#height
         * @type {number}
         */
        this.height = 1;
        /**
         * @name phaserui.Text#x
         * @type {number}
         */
        this.x;
        /**
         * @name phaserui.Text#y
         * @type {number}
         */
        this.y;

        /**
         * @name phaserui.Text#originX
         * @type {number}
         */
        this.originX;
        /**
         * @name phaserui.Text#originY
         * @type {number}
         */
        this.originY;

        /**
         * @name phaserui.Text#displayOriginX
         * @type {number}
         */
        this.displayOriginX;
        /**
         * @name phaserui.Text#displayOriginY
         * @type {number}
         */
        this.displayOriginY;
        this.dirty = false;
    ...
    /**
     * @method phaserui.Text#setFontFamily
     * @param {*} family 
     * @return {*}
     */
    ...
    /**
     * @method phaserui.Text#setFontSize
     * @param {number} size 
     * @return {*}
     */
    setFontSize(size) {
    ...
    /**
     * @method phaserui.Text#setFontStyle
     * @param {*} style 
     * @return {*}
     */
    setFontStyle(style) {
    ...
    /**
     * @method phaserui.Text#setFixedSize
     * @param {number} width 
     * @param {number} height 
     * @return {*}
     */
    ...
    /**
     * @method phaserui.Text#setBackgroundColor
     * @param {*} color 
     * @return {*}
     */
    ...
    /**
     * @method phaserui.Text#setStroke
     * @param {*} color 
    ...
    /**
     * @method phaserui.Text#setShadow
     * @param {number} x 
     * @param {number} y 
     * @param {*} color 
     * @param {*} blur 
    ...
    /**
     * @method phaserui.Text#setShadowOffset
     * @param {number} x 
     * @param {number} y 
     * @return {*}
     */
    ...
    /** 
     * @method phaserui.Text#setShadowColor
     * @param {*} color 
     * @return {*}
     */
    ...
    /**
     * @method phaserui.Text#setShadowBlur
     * @param {*} blur 
     * @return {*}
     */
    setShadowBlur(blur) {
    ...
    /**
     * @method phaserui.Text#setShadowStroke
    ...
    /**
     * @method phaserui.Text#setShadowFill
     * @param {false} enabled 
     * @return {*}
     */
    ...
    /**
     * @method phaserui.Text#setWrapMode
     * @param {*} mode 
     * @return {*}
     */
    setWrapMode(mode) {
    ...
    /**
     * @method phaserui.Text#setWrapWidth
     * @param {number} width 
     * @return {*}
     */
    setWrapWidth(width) {
    ...
    /**
     * @method phaserui.Text#drawAreaBounds
     * @param {*} graphics 
     * @param {*} color 
     * @return {*}
     */
    ...
    /**
     * @method phaserui.Text#setOrigin
     * @param {number} [x] 
     * @param {number} [y] 
     * @return {*} this
     */
    ...
    /**
     * @method phaserui.Text#setOriginFromFrame
     * @return {*} this
     */
    setOriginFromFrame() {
        return this;
    ...
    /**
     * @method phaserui.Text#setDisplayOrigin
     * @param {number} x 
     * @param {number} y 
     * @return {*} this
     */
    ...
    /**
     * @method phaserui.Text#updateDisplayOrigin
     * @return {*} this
     */
    updateDisplayOrigin() {
        return this;
