 ...
 * @param {*} style
 * @param {string} type
 * @param {apowophaserui.Parser} parser
 */
class Text extends GameObject {
    constructor(scene, x, y, text, style, type, parser) {
        ...
        /**
         * @name apowophaserui.Text#displayWidth
         * @type {number}
         */
        this.displayWidth;
        /**
         * @name apowophaserui.Text#displayHeight
         * @type {number}
         */
        this.displayHeight;
        ...
        /**
         * @name apowophaserui.Text#width
         * @type {number}
         */
        this.width = 1;
        /**
         * @name apowophaserui.Text#height
         * @type {number}
         */
        this.height = 1;
        /**
         * @name apowophaserui.Text#x
         * @type {number}
         */
        this.x;
        /**
         * @name apowophaserui.Text#y
         * @type {number}
         */
        this.y;

        /**
         * @name apowophaserui.Text#originX
         * @type {number}
         */
        this.originX;
        /**
         * @name apowophaserui.Text#originY
         * @type {number}
         */
        this.originY;

        /**
         * @name apowophaserui.Text#displayOriginX
         * @type {number}
         */
        this.displayOriginX;
        /**
         * @name apowophaserui.Text#displayOriginY
         * @type {number}
         */
        this.displayOriginY;
        this.dirty = false;
    ...
    /**
     * @method apowophaserui.Text#setText
     * @param {string} value
     * @return {*} this
     */
    setText(value) {
    ...
    /**
     * @method apowophaserui.text#setStyle
     * @param {*} style 
     * @return {*}
     */
    setStyle(style) {
    ...
    /**
     * @method apowophaserui.Text#setFont
     * @param {*} font 
     * @return {*}
     */
    setFont(font) {
    ...
    /**
     * @method apowophaserui.Text#setFontFamily
     * @param {*} family 
     * @return {*}
     */
    ...
    /**
     * @method apowophaserui.Text#setFontSize
     * @param {number} size 
     * @return {*}
     */
    setFontSize(size) {
    ...
    /**
     * @method apowophaserui.Text#setFontStyle
     * @param {*} style 
     * @return {*}
     */
    setFontStyle(style) {
    ...
    /**
     * @method apowophaserui.Text#setFixedSize
     * @param {number} width 
     * @param {number} height 
     * @return {*}
     */
    ...
    /**
     * @method apowophaserui.Text#setBackgroundColor
     * @param {*} color 
     * @return {*}
     */
    ...
    /**
     * @method apowophaserui.Text#setFill
     * @param {*} color 
     * @return {*}
     */
    setFill(color) {
    ...
    /**
     * @method apowophaserui.Text#setColor
     * @param {*} color 
     * @return {*}
     */
    setColor(color) {
    ...
    /**
     * @method apowophaserui.Text#setStroke
     * @param {*} color 
    ...
    /**
     * @method apowophaserui.Text#setShadow
     * @param {number} x 
     * @param {number} y 
     * @param {*} color 
     * @param {*} blur 
    ...
    /**
     * @method apowophaserui.Text#setShadowOffset
     * @param {number} x 
     * @param {number} y 
     * @return {*}
     */
    ...
    /** 
     * @method apowophaserui.Text#setShadowColor
     * @param {*} color 
     * @return {*}
     */
    ...
    /**
     * @method apowophaserui.Text#setShadowBlur
     * @param {*} blur 
     * @return {*}
     */
    setShadowBlur(blur) {
    ...
    /**
     * @method apowophaserui.Text#setShadowStroke
    ...
    /**
     * @method apowophaserui.Text#setShadowFill
     * @param {false} enabled 
     * @return {*}
     */
    ...
    /**
     * @method apowophaserui.Text#setWrapMode
     * @param {*} mode 
     * @return {*}
     */
    setWrapMode(mode) {
    ...
    /**
     * @method apowophaserui.Text#setWrapWidth
     * @param {number} width 
     * @return {*}
     */
    setWrapWidth(width) {
    ...
    /**
     * @method apowophaserui.Text#setAlign
     * @param {*}align
     * @return {*}
     */
    setAlign(align) {
    ...
    /**
     * @method apowophaserui.Text#getText
     * @param {string} text 
     * @param {number} start 
     * @param {number} end
     * @return {string} 
    ...
    /**
     * @method apowophaserui.Text#setSize
     * @param {number} width 
     * @param {number} height 
     * @return {*}
     */
    ...
    /**
     * @method apowophaserui.Text#resize
     * @param {number} width 
     * @param {number} height
     * @return {*} 
     */
    ...
    /**
     * @method apowophaserui.Text#addImage
     * @param {*} key 
     * @param {*} config 
     * @return {*}
     */
    ...
    /**
     * @method apowophaserui.Text#drawAreaBounds
     * @param {*} graphics 
     * @param {*} color 
     * @return {*}
     */
    ...
    /**
     * @method apowophaserui.Text#setOrigin
     * @param {number} [x] 
     * @param {number} [y] 
     * @return {*} this
     */
    ...
    /**
     * @method apowophaserui.Text#setOriginFromFrame
     * @return {*} this
     */
    setOriginFromFrame() {
        return this;
    ...
    /**
     * @method apowophaserui.Text#setDisplayOrigin
     * @param {number} x 
     * @param {number} y 
     * @return {*} this
     */
    setDisplayOrigin(x, y) {
        if (x !== undefined) this.displayOriginX = x;
        if (y !== undefined) this.displayOriginY = y;
        return this;
    }
    /**
     * @method apowophaserui.Text#updateDisplayOrigin
     * @return {*} this
     */
    updateDisplayOrigin() {
        return this;
