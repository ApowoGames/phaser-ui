...
class Text extends GameObject {
    constructor(scene, x, y, text, style, type, parser) {
        ...
        /**
         * @name tooqingui.Text#originX
         * @type {number}
         */
        this.originX;
        /**
         * @name tooqingui.Text#originY
         * @type {number}
         */
        this.originY;

        /**
         * @name tooqingui.Text#displayOriginX
         * @type {number}
         */
        this.displayOriginX;
        /**
         * @name tooqingui.Text#displayOriginY
         * @type {number}
         */
        this.displayOriginY;
        this.dirty = false;
    ...
    /**
     * @method tooqingui.Text#setOrigin
     * @param {number} [x] 
     * @param {number} [y] 
     * @return {*} this
     */
    ...
    /**
     * @method tooqingui.Text#setOriginFromFrame
     * @return {*} this
     */
    setOriginFromFrame() {
        return this;
    ...
    /**
     * @method tooqingui.Text#setDisplayOrigin
     * @param {number} x 
     * @param {number} y 
     * @return {*} this
     */
    ...
    /**
     * @method tooqingui.Text#updateDisplayOrigin
     * @return {*} this
     */
    updateDisplayOrigin() {
        return this;
