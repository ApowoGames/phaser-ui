...
class Sizer extends BaseSizer {
    ...
    /**
     * @method tooqingui.Sizer#destroy
     * @param {*} [fromScene] 
     */
    destroy(fromScene) {
    ...
    /**
     * @method tooqingui.Sizer#setOrientation
     * @param {*} orientation 
     * @return {*} this
     */
    ...
    /**
     * @method tooqingui.Sizer#addSpace
     * @param {*} proportion 
     * @return {*} this
     */
    addSpace(proportion) {
    ...
    /**
     * @name tooqingui.Sizer#childrenProportion
     * @return {*}
     */
