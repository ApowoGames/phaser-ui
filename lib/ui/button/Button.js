...
class Button extends BaseUI {
    constructor(scene, key, frame, downFrame, text, music, dpr, scale, nineConfig) {
        super(scene);
        /**
         * @name phaserui.Button#mDownTime
         * @type {number}
         * @protected
         */
        this.mDownTime = 0;
        /**
         * @name phaserui.Button#mPressDelay
         * @type {number}
         * @protected
         */
        this.mPressDelay = 1000;
        /**
         * @name phaserui.Button#mIsMove
         * @type {boolean}
         * @protected
         * @default false
         */
         ...
         * @name phaserui.Button#ninePatchConfig
         * @type {*}
         * @protected
         */
        this.ninePatchConfig = nineConfig || undefined;
        /**
         * @name phaserui.Button#mKey
         * @type {string}
         * @protected
         */
        this.mKey = key;
        /**
         * @name phaserui.Button#mFrame
         * @type {string}
         * @protected
         */
        this.mFrame = frame;
        /**
         * @name phaserui.Button#mDownFrame
         * @type {string}
         * @protected
         */
        this.mDownFrame = downFrame;
        /**
         * @name phaserui.Button#mText
         * @type {Phaser.GameObjects.Text}
         * @protected
         */
        this.mText;
        /**
         * @name phaserui.Button#mBackground
         * @type {Phaser.GameObjects.Image|phaserui.NineSlicePatch}
         * @protected
         */
        this.mBackground;
    ...
    /**
     * @name phaserui.Button#background
    ...
    /**
     * @method  phaserui.Button#addListen
     */
    addListen() {
        this.removeListen();
    ...
    /**
     * @method  phaserui.Button#removeListen
     */
    removeListen() {
    ...
    /**
     * @method  phaserui.Button#changeNormal
     */
    changeNormal() {
        this.setBgFrame(this.mFrame);
    }
    /**
     * @method  phaserui.Button#changeDown
     */
    changeDown() {
        if (this.mDownFrame) {
    ...
    /**
     * @method  phaserui.Button#setFrame
    ...
    /**
     * @method phaserui.Button#setText
     * @param {string} val 
     */
    setText(val) {
        if (this.mText) {
    ...
    /**
     * @method phaserui.Button#setTextStyle
     * @param {*} style 
     */
    setTextStyle(style) {
        if (this.mText) {
    ...
    /**
     * @method phaserui.Button#setFontStyle
     * @param {string} val 
     */
    setFontStyle(val) {
        if (this.mText) {
    ...
    /**
     * @method phaserui.Button#setTextOffset
     * @param {number} x 
     * @param {number} y 
     */
    setTextOffset(x, y) {
    ...
    /**
     * @method phaserui.Button#setTextColor
     * @param {string} color 
     */
    setTextColor(color) {
        if (this.mText) {
    ...
    /**
     * @method phaserui.Button#createBackground
     */
    createBackground() {
    ...
    /**
     * @method phaserui.Button#setBgFrame
     * @param {string|number} frame 
     */
    setBgFrame(frame) {
    ...
    /**
     * @method phaserui.Button#buttonStateChange
     * @param {phaserui.ButtonState} state 
     */
    ...
    /**
     * @method phaserui.Button#onPointerMoveHandler
    ...
    /**
     * @method phaserui.Button#onPointerUpHandler
     * @param {Phaser.Input.Pointer} pointer 
     */
    ...
    /**
      * @method phaserui.Button#onPointerDownHandler
      * @param {Phaser.Input.Pointer} pointer 
      */
