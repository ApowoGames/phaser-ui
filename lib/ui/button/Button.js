...
/**
 * @namespace apowophaserui.ClickInterval
 */
...
class Button extends BaseUI {
    ...
    */
    ...
    /**
     * @method  apowophaserui.Button#setInteractiveSize
     * @param {number} width 
     * @param {number} height 
     */
    setInteractiveSize(width, height) {
        this.isFixedInteractive = true;
    ...
    createBackground() {
        if (this.mFrame) {
            ...
            if (!this.isFixedInteractive) this.setSize(this.mBackground.width, this.mBackground.height);
...
export { Button, ButtonState, NinePatchConfig, ButtonConfig, ClickInterval };
