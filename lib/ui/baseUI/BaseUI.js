...
class BaseUI extends Phaser.GameObjects.Container {
    constructor(scene, dpr, scale) {
        ...
        */
        ...
        /**
        * @name phaserui.BaseUI#mInitialized
        * @type {boolean}
        * @protected
        */
        ...
        /**
        * @name phaserui.BaseUI#interactiveBoo
        * @type {boolean}
        * @protected
        */
    ...
    /**
     * @method phaserui.BaseUI#setFollow
     * @param {*} gameObject 
    ...
    /**
     * @method phaserui.BaseUI#updatePos
     */
    updatePos() {
        if (!this.mShow)
            return;
    ...
    /**
     * @method phaserui.BaseUI#setInteractive
    ...
    /**
     * @method phaserui.BaseUI#disInteractive
     */
    disInteractive() {
        this.interactiveBoo = false;
    ...
    /**
     * @method phaserui.BaseUI#addListen
     */
    addListen() {
    ...
    /**
     * @method phaserui.BaseUI#removeListen
     */
    removeListen() {
        // if (!this.mInitialized) return;
        // this.scene.input.off("pointerup", this.sceneClick, this);
    ...
    /**
     * @method phaserui.BaseUI#playSound
     * @param {*} config 
     */
    playSound(config) {
        if (this.silent)
    ...
    /**
     * @description {key:string,field:phaserui.Interface.Sound.SoundField,soundConfig:Phaser.Types.sound.soundConfig}
     * @method phaserui.BaseUI#startPlay
     * @param {*} config 
     */
    startPlay(config) {
        if (this.silent)
    ...
    /**
     * @method phaserui.BaseUI#stopSound
     */
    stopSound() {
        if (this.silent)
            return;
    ...
    /**
     * @method phaserui.BaseUI#pauseSound
     */
    pauseSound() {
        if (this.silent)
            return;
    ...
    /**
     * @method phaserui.BaseUI#resumeSound
     */
    resumeSound() {
        if (this.silent)
            return;
    ...
    /**
     * @method phaserui.BaseUI#setSilent
     * @param {boolean} boo 
     */
    setSilent(boo) {
        this.silent = boo;
    ...
    /**
     * @method phaserui.BaseUI#destroy
     */
    destroy() {
        this.soundMap.forEach((sound) => {
            if (sound.isPlaying)
    ...
    // }
    /**
     * @method phaserui.BaseUI#checkPointerDelection
