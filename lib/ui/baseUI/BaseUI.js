...
class BaseUI extends Phaser.GameObjects.Container {
    ...
    /**
     * @method tooqinui.BaseUI.BaseUI#setFollow
     * @param {*} gameObject 
    ...
    /**
     * @method tooqinui.BaseUI.BaseUI#updatePos
     */
    updatePos() {
        if (!this.mShow)
            return;
    ...
    /**
     * @method tooqinui.BaseUI.BaseUI#setInteractive
     * @param {*} shape 
    ...
    /**
     * @method tooqinui.BaseUI.BaseUI#disInteractive
     */
    disInteractive() {
        this.interactiveBoo = false;
    ...
    /**
     * @method tooqinui.BaseUI.BaseUI#addListen
     */
    addListen() {
    ...
    /**
     * @method tooqinui.BaseUI.BaseUI#removeListen
     */
    removeListen() {
        // if (!this.mInitialized) return;
        // this.scene.input.off("pointerup", this.sceneClick, this);
    ...
    /**
     * @method tooqinui.BaseUI.BaseUI#playSound
     * @param {*} config 
     */
    playSound(config) {
        if (this.silent)
    ...
    /**
     * @description {key:string,field:tooqinui.Interface.Sound.SoundField,soundConfig:Phaser.Types.sound.soundConfig}
     * @method tooqinui.BaseUI.BaseUI#startPlay
     * @param {*} config 
     */
    startPlay(config) {
        if (this.silent)
    ...
    /**
     * @method tooqinui.BaseUI.BaseUI#stopSound
     */
    stopSound() {
        if (this.silent)
            return;
    ...
    /**
     * @method tooqinui.BaseUI.BaseUI#pauseSound
     */
    pauseSound() {
        if (this.silent)
            return;
    ...
    /**
     * @method tooqinui.BaseUI.BaseUI#resumeSound
     */
    resumeSound() {
        if (this.silent)
            return;
    ...
    /**
     * @method tooqinui.BaseUI.BaseUI#setSilent
     * @param {boolean} boo 
     */
    setSilent(boo) {
        this.silent = boo;
    ...
    /**
     * @method tooqinui.BaseUI#destroy
     */
    destroy() {
        this.soundMap.forEach((sound) => {
            if (sound.isPlaying)
    ...
    // }
    /**
     * @method tooqinui.BaseUI.BaseUI#checkPointerDelection
