...
class BaseScroller extends BaseUI {
    constructor(scene, config, gameObject) {
        ...
        this.mConfig = config;
        /**
         * @name phaserui.BaseScroller#soundGroup
    ...
    /**
    * @method phaserui.BaseScroller#setEnable
    ...
    */
    ...
    /**
    * @method phaserui.BaseScroller#setValue
    * @param {number} value 
    */
    setValue(value) {
        if (this.mScroller)
    ...
    /**
     * @method phaserui.BaseScroller#adjustBackDeceleration
    ...
    /**
     * @method phaserui.BaseScroller#adjustSlidingDeceleration
     * @param {number} deceler 
     */
    ...
    /**
    * @method phaserui.BaseScroller#adjustScrollMode
    * @param {number} mode 
    */
    ...
    /**
    * @method phaserui.BaseScroller#adjustDragThreshol
    * @param {number} hold 
    */
    ...
    /***
     * @method phaserui.BaseScroller#adjustMask
     * @param {number}width
     * @param {number}height
     * @param {number}x
     * @param {number}y
    ...
    /**
    * @method phaserui.BaseScroller#setBounds
    * @param {number} value0 
    * @param {number} value1 
    */
    ...
    /**
     * @name phaserui.BaseScroller#bounds
     * @return {number[]}
     */
    get bounds() {
    ...
    /**
     * @method phaserui.BaseScroller#resize
     * @param {number} width 
     * @param {number} height 
     * @param {number} value0 
     * @param {number} value1 
    ...
    // }
    /**
     * @method phaserui.BaseScroller#clearInteractiveObject
     */
    ...
    /**
     * @method phaserui.BaseScroller#setInteractiveObject
     * @param {*} obj 
     */
    ...
    /**
     * @method phaserui.BaseScroller#removeInteractiveObject
     * @param {*} obj
     */
    ...
    /**
     * @name phaserui.BaseScroller#left
     * @return {number}
     */
    get left() {
    ...
    /**
    * @name phaserui.BaseScroller#right
    * @return {number}
    */
    get right() {
        return this.mGameObject.width / 2;
    ...
    /**
    * @name phaserui.BaseScroller#top
    * @return {number}
    */
    get top() {
    ...
    /**
    * @name phaserui.BaseScroller#bottom
    * @return {number}
    */
    get bottom() {
        return this.mGameObject.height / 2;
    ...
    /**
     * @name phaserui.BaseScroller#boundPad0
     * @return {number}
     */
    get boundPad0() {
    ...
    /**
    * @name phaserui.BaseScroller#boundPad1
    * @return {number}
    */
    get boundPad1() {
    ...
    /**
     * @method phaserui.BaseScroller#refreshBound
    ...
    /**
    * @method phaserui.BaseScroller#checkPointerInBounds
    * @param {*} gameObject 
