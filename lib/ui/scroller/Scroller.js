 ...
 * @param {*} gameObject
 * @param {apowophaserui.ScrollerConfig} config
 */
class BaseScroller extends BaseUI {
    ...
    */
    ...
    /**
     * @method apowophaserui.BaseScroller#addListen
     */
    addListen() {
        if (!this.scene)
            return;
    ...
    /**
     * @method apowophaserui.BaseScroller#removeListen
     */
    removeListen() {
        this.mMoveing = false;
        if (!this.scene)
    ...
    /**
     * @method apowophaserui.BaseScroller#destroy
     */
    destroy() {
        this.mMoveing = false;
        if (this.mGameObject)
