...
class BaseScroller extends BaseUI {
    constructor(scene, config, gameObject) {
        ...
        this.mConfig = config;
        /**
         * @name tooqingui.BaseScroller#soundGroup
    ...
    /**
    * @method tooqingui.BaseScroller#setEnable
    ...
    */
    ...
    /**
    * @method tooqingui.BaseScroller#setValue
    * @param {number} value 
    */
    setValue(value) {
        if (this.mScroller)
    ...
    /**
     * @method tooqingui.BaseScroller#adjustBackDeceleration
    ...
    /**
     * @method tooqingui.BaseScroller#adjustSlidingDeceleration
     * @param {number} deceler 
     */
    ...
    /**
    * @method tooqingui.BaseScroller#adjustScrollMode
    * @param {number} mode 
    */
    ...
    /**
    * @method tooqingui.BaseScroller#adjustDragThreshol
    * @param {number} hold 
    */
    ...
    /***
     * @method tooqingui.BaseScroller#adjustMask
     * @param {number}width
     * @param {number}height
     * @param {number}x
     * @param {number}y
    ...
    /**
    * @method tooqingui.BaseScroller#setBounds
    * @param {number} value0 
    * @param {number} value1 
    */
    ...
    /**
     * @name tooqingui.BaseScroller#bounds
     * @return {number[]}
     */
    get bounds() {
    ...
    /**
     * @method tooqingui.BaseScroller#resize
     * @param {number} width 
     * @param {number} height 
     * @param {number} value0 
     * @param {number} value1 
    ...
    // }
    /**
     * @method tooqingui.BaseScroller#clearInteractiveObject
     */
    ...
    /**
     * @method tooqingui.BaseScroller#setInteractiveObject
     * @param {*} obj 
     */
    ...
    /**
     * @method tooqingui.BaseScroller#removeInteractiveObject
     * @param {*} obj
     */
    ...
    /**
     * @name tooqingui.BaseScroller#left
     * @return {number}
     */
    get left() {
    ...
    /**
    * @name tooqingui.BaseScroller#right
    * @return {number}
    */
    get right() {
        return this.mGameObject.width / 2;
    ...
    /**
    * @name tooqingui.BaseScroller#top
    * @return {number}
    */
    get top() {
    ...
    /**
    * @name tooqingui.BaseScroller#bottom
    * @return {number}
    */
    get bottom() {
        return this.mGameObject.height / 2;
    ...
    /**
     * @name tooqingui.BaseScroller#boundPad0
     * @return {number}
     */
    get boundPad0() {
    ...
    /**
    * @name tooqingui.BaseScroller#boundPad1
    * @return {number}
    */
    get boundPad1() {
    ...
    /**
     * @method tooqingui.BaseScroller#refreshBound
    ...
    /**
    * @method tooqingui.BaseScroller#checkPointerInBounds
    * @param {*} gameObject 
