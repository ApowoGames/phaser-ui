...
class GameScroller extends BaseUI {
    constructor(scene, config, gameObject) {
        ...
        this.mConfig = config;
        /**
         * @name apowophaserui.GameScroller#soundGroup
    ...
    */
    ...
    // }
    /**
     * @method apowophaserui.GameScroller#clearInteractiveObject
     */
    ...
    /**
     * @method apowophaserui.GameScroller#checkPointerInBounds
     * @param {*} gameObject 
    ...
    /**
     * @method apowophaserui.gameScroller#onScrollValueChange
     * @param {number} value 
     */
