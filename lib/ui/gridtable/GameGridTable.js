...
class GameGridTable extends Phaser.GameObjects.Container {
    ...
    /**
     * @method apowophaserui.GameGridTable#setpartItems
     * @param {*} items 
     */
    setPartItems(items) {
        if (this.mGridTable) {
            this.mGridTable.setPartItems(items);
        }
    }
    /**
    ...
    addListen() {
        if (this.mGridTable) {
            ...
            this.mGridTable.on("cell.out", this.cellOutHandler, this);
            this.mGridTable.on("cell.down", this.cellDownHandler, this);
            this.mGridTable.on("cell.over", this.cellOverHandler, this);
        }
    }
    /**
    ...
    */
    removeListen() {
        if (this.mGridTable) {
            ...
            this.mGridTable.off("cell.out", this.cellOutHandler, this);
            this.mGridTable.off("cell.down", this.cellDownHandler, this);
            this.mGridTable.off("cell.over", this.cellOverHandler, this);
        }
    }
    /**
    ...
    */
    ...
    /**
     * @method apowophaserui.GameGridTable#cellOutHandler
     * @param {*} table
     * @param {number} index 
     */
    cellOutHandler(table, index) {
        this.emit("cellOut", table, index);
    }

    /**
     * @method apowophaserui.GameGridTable#cellOverHandler
     * @param {*} table
     * @param {number} index 
     */
    cellOverHandler(table, index) {
        this.emit("cellOver", table, index);
    }

    /**
     * @method apowophaserui.GameGridTable#cellDownHandler
     * @param {*} table
     * @param {number} index 
     */
    cellDownHandler(table, index) {
        this.emit("cellDown", table, index);
    }
}
