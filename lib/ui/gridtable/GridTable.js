...
class GridTable extends Scrollable {
    constructor(scene, config) {
        ...
        super(scene, config);
        this.table = table;
        this.addChildrenMap("table", this.table);
        ...
        TableOnCellVisible.call(this, this.table);

        if (GetValue(tableConfig, "interactive", true)) {
            TableSetInteractive.call(this, this.table, tableConfig);
        }
    ...
    setCellHeight(cellIdx, height) {
        this.table.getCell(cellIdx, true);
        return this;
    }
