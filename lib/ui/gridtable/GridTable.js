 ...
 * @param {*} config
 * @classdesc config.table.interacitve boolean||object{cellclick,celltap,cellover,cellpress,cellswipe}
 */
class GridTable extends Scrollable {
    constructor(scene, config) {
        ...
        var valueChange = GetValue(config, "onScrollValueChange", null);
        table.setScrollValueChange(valueChange, scope);
