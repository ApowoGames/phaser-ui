...
const Patches_config_1 = require("../interface/baseUI/Patches.config");
const BaseUI_1 = require("../baseUI/BaseUI");
const GetValue = Phaser.Utils.Objects.GetValue;
/**
 * @class NineSlicePatch
 * @memberof TooqinUI.NinePatch
 * @constructor
 ...
 * @param {number} height
 */
class NineSlicePatch extends BaseUI_1.BaseUI {
    ...
    /**
     * @method TooqinUI.NineSlicePatch#resize
     * @param {number} width 
     * @param {number} height 
     */
    resize(width, height) {
    ...
    /**
     * @method TooqinUI.NineSlicePatch#getConfig
     * @return {*}
     */
    getConfig() {
    ...
    /**
     * @method TooqinUI.NineSlicePatch#setConfig
     * @param {*} config 
     */
    setConfig(config) {
        ...
        Patches_config_1.normalizePatchesConfig(config);
    }
    /**
     * @method TooqinUI.NineSlicePatch#setTexture
     * @param {string} key 
     * @param {string} frame 
     */
    ...
    /**
     * @method TooqinUI.NineSlicePatch#setFrame
     * @param {string} frame 
     */
    setFrame(frame) {
    ...
    /**
     * @method TooqinUI.NineSlicePatch#setSize
     * @param {number} width 
     * @param {number} height 
     */
    ...
    /**
     * @method TooqinUI.NineSlicePatch#setTint
     * @param {*} tint 
     */
    setTint(tint) {
        this.tint = tint;
    ...
    /**
     * @method TooqinUI.NineSlicePatch#setTintFill
     * @param {*} tint 
     */
    setTintFill(tint) {
        this.tint = tint;
    ...
    /**
     * @name TooqinUI.NineSlicePatch#tintFill
     * @return {boolean}
     */
    get tintFill() {
    ...
    /**
     * @method TooqinUI.NineSlicePatch#clearTine
     */
    clearTint() {
    ...
    /**
     * @method TooqinUI.NineSlicePatch#createPatches
     */
    createPatches() {
    ...
    /**
     * @method TooqinUI.NineSlicePatch#drawPatches
     */
    drawPatches() {
    ...
    /**
     * @method TooqinUI.NineSlicePatch#createPatchFrame
     * @param {string} patch
     * @param {number} x 
     * @param {number} y 
     * @param {number} width 
    ...
    /**
     * @method TooqinUI.NineSlicePatch#getPatchNameByIndex
     * @param {number} index 
     * 
     */
    ...
    /**
     * @method TooqinUI.NineSlicePatch#calculScale
     * @param {number} num0 
     * @param {number} num1 
     * @return {number}
     */
...
exports.NineSlicePatch = NineSlicePatch;
