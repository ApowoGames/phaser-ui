...
class NineSlicePatch extends BaseUI_1.BaseUI {
    ...
    /**
     * @method tooqingui.NineSlicePatch#resize
     * @param {number} width 
     * @param {number} height 
     */
    resize(width, height) {
    ...
    /**
     * @method tooqingui.NineSlicePatch#getConfig
     * @return {*}
     */
    getConfig() {
    ...
    /**
     * @method tooqingui.NineSlicePatch#setConfig
     * @param {*} config 
     */
    setConfig(config) {
    ...
    /**
     * @method tooqingui.NineSlicePatch#setTexture
     * @param {string} key 
     * @param {string} frame 
     */
    ...
    /**
     * @method tooqingui.NineSlicePatch#setFrame
     * @param {string} frame 
     */
    setFrame(frame) {
    ...
    /**
     * @method tooqingui.NineSlicePatch#setSize
     * @param {number} width 
     * @param {number} height 
     */
    ...
    /**
     * @method tooqingui.NineSlicePatch#setTint
     * @param {*} tint 
     */
    setTint(tint) {
        this.tint = tint;
    ...
    /**
     * @method tooqingui.NineSlicePatch#setTintFill
     * @param {*} tint 
     */
    setTintFill(tint) {
        this.tint = tint;
    ...
    /**
     * @name tooqingui.NineSlicePatch#tintFill
     * @return {boolean}
     */
    get tintFill() {
    ...
    /**
     * @name tooqingui.NineSlicePatch.isTinted
     * @return {boolean}
     */
    get isTinted() {
    ...
    /**
     * @method tooqingui.NineSlicePatch#clearTine
     */
    clearTint() {
    ...
    /**
     * @method tooqingui.NineSlicePatch#createPatches
     */
    createPatches() {
    ...
    /**
     * @method tooqingui.NineSlicePatch#drawPatches
     */
    drawPatches() {
    ...
    /**
     * @method tooqingui.NineSlicePatch#createPatchFrame
     * @param {string} patch
     * @param {number} x 
     * @param {number} y 
     * @param {number} width 
    ...
    /**
     * @method tooqingui.NineSlicePatch#getPatchNameByIndex
     * @param {number} index 
     * 
     */
    ...
    /**
     * @method tooqingui.NineSlicePatch#calculScale
     * @param {number} num0 
     * @param {number} num1 
     * @return {number}
     */
