...
class NineSlicePatch extends BaseUI {
    ...
    /**
     * @method apowophaserui.NineSlicePatch#setConfig
     * @param {*} config 
     */
    setConfig(config) {
    ...
    /**
     * @method apowophaserui.NineSlicePatch#clearTine
     */
    clearTint() {
    ...
    /**
     * @method apowophaserui.NineSlicePatch#calculScale
     * @param {number} num0 
     * @param {number} num1 
     * @return {number}
     */
    ...
    /**
     * @function apowophaserui.NineSlicePatch#normalizePatchesConfig
     * @param {*} config 
     * @return {*}
     */
