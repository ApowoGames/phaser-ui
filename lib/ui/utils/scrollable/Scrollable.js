...
class Scrollable extends Sizer {
    constructor(scene, config) {
        ...
        super(scene, config);
        this.type = GetValue(config, 'type', 'TooqingScrollable');
    ...
    /**
     * @method apowophaserui.Scrollable#layout
     * @param {*} [parent] 
    ...
    /**
     * @method apowophaserui.Scrollable#scrollToTop
     * @return {*}this
     */
    scrollToTop() {
        this.t = 0;
    ...
    /**
     * @method apowophaserui.Scrollable#scrollToBottom
     * @return {*}this
     */
    scrollToBottom() {
        this.t = 1;
    ...
    /**
     * @method apowophaserui.Scrollable#setSliderEnable
    ...
    /**
     * @method apowophaserui.Scrollable#setScrollerEnable
     * @param {boolean}enabled
     * @return {*}this
     */
