...
class MessageBox extends Panel {
    ...
    /**
     * @method apowophaserui.MessageBox#show
     * @param {*} config 
     */
    show(config) {
    ...
    /**
     * @method apowophaserui.MessageBox#preload
     */
    preload() {
    ...
    /**
     * @method apowophaserui.MessageBox#setText
     * @param {string} str 
     */
    setText(str) {
        if (this.mContent)
    ...
    /**
     * @method apowophaserui.MessageBox#setTitle
     * @param {string} str 
     */
    setTitle(str) {
        if (this.mTitleLabel)
    ...
    /**
     * @method apowophaserui.MessageBox#setbtnNum
     * @param {number} btnNum 
     */
    setbtnNum(btnNum) {
        if (btnNum) {
    ...
    /**
     * @method apowophaserui.MessageBox#addResources
     * @param {string} key 
     * @param {*} resource 
     */
    ...
    /**
     * @method apowophaserui.MessageBox#init
     */
    init() {
    ...
    /**
     * @method apowophaserui.MessageBox#onOkHandler
     */
    onOkHandler() {
        if (!this.mCurData) {
            return;
    ...
    /**
     * @method apowophaserui.MessageBox#onCancelHandler
     */
    onCancelHandler() {
        if (!this) {
            return;
