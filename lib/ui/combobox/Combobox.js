 ...
 * @memberof TooqinUI.SelectCallItem
 * @constructor
...
class SelectCallItem extends BaseUI_1.BaseUI {
    constructor(scene, selectCallUI, wid, hei, music) {
        ...
        this.mSelect = false;
        /**
         * @name TooqinUI.SelectCallItem#mSelectCallUI
         * @type {*}
         * @protected
         */
        this.mSelectCallUI = selectCallUI;
        /**
         * @name TooqinUI.SelectCallItem#soundGroup
         * @type {*}
         * @protected
         */
        this.soundGroup = music;
        /**
         * @name TooqinUI.SelectCallItem#text
        ...
        /**
         * @name TooqinUI.SelectCallItem#mSelectBG
    ...
    /**
     * @method TooqinUI.SelectCallItem#setInteractive
     */
    setInteractive() {
    ...
    /**
     * @method TooqinUI.SelectCallItem#addListen
     */
    addListen() {
    ...
    /**
     * @method TooqinUI.SelectCallItem#removeListen
     */
    removeListen() {
    ...
    /**
     * @name TooqinUI.SelectCallItem#itemData
     * @type {*}
     * @return {*}
     */
    get itemData() {
    ...
    /**
     * @name TooqinUI.SelectCallItem#destroy
     */
    destroy() {
    ...
    /**
     * @name TooqinUI.SelectCallItem#selected
     * @type {boolean}
     * @return {boolean}
     */
    get selected() {
    ...
    /**
     * @name TooqinUI.SelectCallItem#setInteractive
     * @type {boolean}
     * @return {boolean}
     */
    get interactive() {
    ...
    /**
     * @method TooqinUI.SelectCallItem#overHandler
     */
    overHandler() {
    ...
    /**
     * @method TooqinUI.SelectCallItem#selectHandler
     */
    selectHandler() {
        if (!this.interactiveBoo) {
    ...
    /**
     * @method TooqinUI.SelectCallItem#outHandler
     */
    outHandler() {
        if (!this.interactiveBoo)
            return;
...
class ComboBox extends BaseUI_1.BaseUI {
    constructor(scene, config) {
        ...
        /**
         * @name TooqinUI.ComboBox#itemList
         * @type {*[]}
         */
        this.itemList = [];
        this.mConfig = config;
    ...
    /**
     * @method TooqinUI.ComboBox#selectCall
     * @param {*} itemData 
     */
    selectCall(itemData) {
    ...
    /**
     * @method TooqinUI.ComboBox#addListen
     */
    addListen() {
        super.addListen();
    ...
    /**
     * @method TooqinUI.ComboBox#removeListen
     */
    removeListen() {
        super.removeListen();
    ...
    /**
     * @method TooqinUI.ComboBox#destroy
     */
    destroy() {
        if (this.itemList) {
    ...
    /**
     * @method TooqinUI.ComboBox#onLoadCompleteHandler
     */
    ...
    /**
     * @method TooqinUI.ComboBox#openHandler
     */
    openHandler() {
        if (!this.interactiveBoo) {
            if (this.soundGroup && this.soundGroup.disabled)
    ...
    /**
     * @method TooqinUI.ComboBox#showTween
     * @param {boolean} open 
     */
    showTween(open) {
        if (open) {
    ...
    /**
     * @method TooqinUI.ComboBox#showTweenItem
     * @param {boolean} open 
     */
    showTweenItem(open) {
        const len = this.itemList.length;
    ...
    /**
     * @method TooqinUI.ComboBox#createTexture
