...
class SelectCallItem extends BaseUI {
    constructor(scene, selectCallUI, wid, hei, music) {
        super(scene);
        /**
         * @name apowophaserui.SelectCallItem#mSelect
         * @type {boolean}
         * @protected
         */
        this.mSelect = false;
        ...
        /**
         * @name apowophaserui.SelectCallItem#mText
    ...
    */
    ...
    /**
     * @name apowophaserui.SelectCallItem#interactive
     * @type {boolean}
     * @return {boolean}
     */
    get interactive() {
...
class ComboBox extends BaseUI {
    constructor(scene, config) {
        super(scene);
        /**
        * @name apowophaserui.ComboBox#mIsopen
        * @type {boolean}
        */
        this.mIsopen = false;
        /**
        ...
        this.itemList = [];
        /**
        * @name apowophaserui.ComboBox#mConfig
        * @type {any}
        */
        this.mConfig = config;
    ...
    /**
     * @method apowophaserui.ComboBox#setText
     * @type {string[]}
     */
    setText(value) {
        if (!this.mInitialized) {
