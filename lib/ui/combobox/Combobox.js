...
class SelectCallItem extends BaseUI {
    constructor(scene, selectCallUI, wid, hei, music) {
        ...
        this.mSelect = false;
        /**
         * @name phaserui.SelectCallItem#mSelectCallUI
         * @type {*}
         * @protected
         */
        this.mSelectCallUI = selectCallUI;
        /**
         * @name phaserui.SelectCallItem#soundGroup
         * @type {*}
         * @protected
         */
        this.soundGroup = music;
        /**
         * @name phaserui.SelectCallItem#text
        ...
        /**
         * @name phaserui.SelectCallItem#mSelectBG
    ...
    /**
     * @method phaserui.SelectCallItem#addListen
     */
    addListen() {
    ...
    /**
     * @method phaserui.SelectCallItem#removeListen
     */
    removeListen() {
    ...
    /**
     * @name phaserui.SelectCallItem#itemData
     * @type {*}
     * @return {*}
     */
    get itemData() {
    ...
    /**
     * @name phaserui.SelectCallItem#destroy
     */
    destroy() {
    ...
    /**
     * @name phaserui.SelectCallItem#selected
     * @type {boolean}
     * @return {boolean}
     */
    get selected() {
    ...
    /**
     * @name phaserui.SelectCallItem#setInteractive
     * @type {boolean}
     * @return {boolean}
     */
    get interactive() {
    ...
    /**
     * @method phaserui.SelectCallItem#overHandler
     */
    overHandler() {
    ...
    /**
     * @method phaserui.SelectCallItem#selectHandler
     */
    selectHandler() {
        if (!this.interactiveBoo) {
    ...
    /**
     * @method phaserui.SelectCallItem#outHandler
     */
    outHandler() {
        if (!this.interactiveBoo)
            return;
...
class ComboBox extends BaseUI {
    constructor(scene, config) {
        ...
        /**
         * @name phaserui.ComboBox#itemList
         * @type {any[]}
         */
        this.itemList = [];
        this.mConfig = config;
    ...
    /**
     * @method phaserui.ComboBox#selectCall
     * @param {*} itemData 
     */
    selectCall(itemData) {
    ...
    /**
     * @method phaserui.ComboBox#addListen
     */
    addListen() {
        super.addListen();
    ...
    /**
     * @method phaserui.ComboBox#removeListen
     */
    removeListen() {
        super.removeListen();
    ...
    /**
     * @method phaserui.ComboBox#destroy
     */
    destroy() {
        if (this.itemList) {
    ...
    /**
     * @method phaserui.ComboBox#onLoadCompleteHandler
     */
    ...
    /**
     * @method phaserui.ComboBox#openHandler
     */
    openHandler() {
        if (!this.interactiveBoo) {
            if (this.soundGroup && this.soundGroup.disabled)
    ...
    /**
     * @method phaserui.ComboBox#showTween
     * @param {boolean} open 
     */
    showTween(open) {
        if (open) {
    ...
    /**
     * @method phaserui.ComboBox#showTweenItem
     * @param {boolean} open 
     */
    showTweenItem(open) {
        const len = this.itemList.length;
    ...
    /**
     * @method phaserui.ComboBox#createTexture
